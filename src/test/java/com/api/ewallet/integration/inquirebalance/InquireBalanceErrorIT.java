...
class InquireBalanceErrorIT extends InquireBalanceTestDataFactory {
    ...
    @Test
    void testWalletNotFoundIT() throws Exception{
        User mockUser = User.builder().userId("USER001").build();
        ...
        testBusinessError("NONEXISTENT", "EWLBE404", "Not Found Error", "404", "Wallet not found");
    }
