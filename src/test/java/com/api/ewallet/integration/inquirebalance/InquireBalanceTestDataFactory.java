...
public abstract class InquireBalanceTestDataFactory extends EWalletApplicationTests {

    protected static final String URI = "/v1/api/wallet/inquireBalance";;
    ...
    public static String getJsonResponse(String fileName){
        try {
            return TestUtil.getJsonFromFile(String.join("/", "inquirebalance", fileName + RESPONSE));
